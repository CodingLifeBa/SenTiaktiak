...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 04 mai 2024 à 16:35
...
(5, '2024_05_04_132417_create_courses_table', 1),
(6, '2024_05_04_135633_create_offres_table', 1),
(7, '2024_05_04_140112_create_voitures_table', 1);
...
ALTER TABLE `voitures`
  ADD PRIMARY KEY (`id`),
  ADD KEY `voitures_taximan_id_foreign` (`taximan_id`);
...
--
ALTER TABLE `voitures`
  ADD CONSTRAINT `voitures_taximan_id_foreign` FOREIGN KEY (`taximan_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
